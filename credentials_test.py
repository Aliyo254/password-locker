...
class TestContact(unittest.TestCase):
    ...
    def test_find_credentials_by_platform_name(self):
        ...
        found_credential=Credentials.find_by_platform_name("test")
        self.assertEqual(found_credential.platform_name,test_credentials.platform_name)
    ...
    def test_copy_username(self):
         ...
         '''
         self.new_credentials.save_credentials()
         Credentials.copy_username("twitter")
